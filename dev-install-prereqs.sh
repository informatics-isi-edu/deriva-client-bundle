...
pip install markdown bdbag[boto,globus] fair-research-login git+https://github.com/anthony-tuininga/cx_Freeze.git@9e06b761740a9e93431ee7ea8d0b10f786446a6a
